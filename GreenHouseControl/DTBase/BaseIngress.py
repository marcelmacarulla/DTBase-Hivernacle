...
#from .Utils import DEFAULT_USER_EMAIL, DEFAULT_USER_PASS

from .Utils import auth_backend_call, log_rest_response, login
...
class BaseService:
    ...
    def post_service_data(
        ...
        self._backend_login(dt_user_email, dt_user_password) #I had to change email for password
